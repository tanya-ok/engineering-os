...
- [Work-graph dashboard](dashboard.md) - the beads graph by project, with the ready queue.
...
!!! note "Status"
    ...
    the `plan` and `clone-projects` skills, work-tracking (beads Phase A), the
    work-graph dashboard, and this docs site are all in place. Claude Code hooks and the Linear/planning
